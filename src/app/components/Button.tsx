    ...
    return (
      <>
        <button className="group relative inline-flex h-[calc(48px+8px)] w-[200px]  items-center justify-center rounded-full  py-1 pl-6 pr-14 font-medium bg-pink-500 text-white">
          ...
          <div className="absolute right-1 inline-flex h-12 w-12 items-center justify-end rounded-full dark:bg-[#5052e7] bg-[#1e1f3d] transition-[width] group-hover:w-[calc(100%-8px)]">
