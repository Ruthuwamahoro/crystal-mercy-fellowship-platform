...
//   const [playMessageSound] = useSound(MESSAGE_SOUND_URL, { 
//     volume: 0.5,
...
//   const generateResponse = useCopilotAction({
//     name: "generateChatResponse",
//     description: "Generate a response to the user's message in a helpful and friendly way",
//     parameters: [
//       {
//         name: "userMessage",
...
//           },
//           body: JSON.stringify({ message: params.userMessage }),
//         });
...
//         return data.message; // Ensure this returns a value
//       } catch (error) {
...
//     try {
//       const aiResponse = await generateResponse({ userMessage: userMessage.message });
